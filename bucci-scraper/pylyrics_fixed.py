'''
This was taken and modified from geekpradd's project PyLyrics. It can be found at:

https://github.com/geekpradd/PyLyrics

Fixes were made so that it worked with the current site by:

https://github.com/tjfaust

using this branch:

https://github.com/tjfaust/PyLyrics
